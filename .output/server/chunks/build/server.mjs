import { inject, unref, hasInjectionContext, getCurrentInstance, version, defineAsyncComponent, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, Fragment, useSSRContext, createApp, withCtx, createVNode, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, nextTick, mergeProps, getCurrentScope } from 'vue';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-CBap9Y5g.mjs')
  },
  {
    name: "crew",
    path: "/crew",
    component: () => import('./crew-CgrVtxUg.mjs')
  },
  {
    name: "dress-code",
    path: "/dress-code",
    component: () => import('./dress-code-C4ue3rd2.mjs')
  },
  {
    name: "faq",
    path: "/faq",
    component: () => import('./faq-2YD2BRDP.mjs')
  },
  {
    name: "gifts",
    path: "/gifts",
    component: () => import('./gifts-Cezt_Pxo.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D_DJwiKm.mjs')
  },
  {
    name: "schedule",
    path: "/schedule",
    component: () => import('./schedule-CdQfU8Ge.mjs')
  },
  {
    name: "todo",
    path: "/todo",
    component: () => import('./todo-DuM6RIC8.mjs')
  }
];
...
const translations_DWHk0W6D9U = /* @__PURE__ */ defineNuxtPlugin(() => {
  let currentLang = "es";
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CzXS9RA8.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-iJ2Wr5L5.mjs'));
...
export { useRouter as a, resolveRouteObject as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry$1 as default, injectHead as i, navigateTo as n, resolveUnrefHeadInput as r, useNuxtApp as u };
